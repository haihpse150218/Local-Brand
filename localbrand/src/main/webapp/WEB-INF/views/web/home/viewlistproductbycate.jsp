				...
				<nav aria-label="Page navigation">
					<ul class="pagination justify-content-center mb-3">
						<li class="page-item ${homePage==1?'disabled':''}"><a
							class="page-link  " href="viewlistproductbycate.do?op=FirstPage"
							aria-label="Previous"> <span aria-hidden="true">&laquo;</span>
						</a></li>
						<li class="page-item  ${homePage==1?'disabled':''}"><a
							class="page-link" href="viewlistproductbycate.do?op=PreviousPage"
							aria-label="Next"> <span aria-hidden="true"><</span>
						</a></li>
						<li
							class="page-item  ${homePage==listNumberBox.get(0)?'active':''}">
							<a class="page-link"
							href="viewlistproductbycate.do?op=GotoPage&gotoPage=${listNumberBox.get(0)}">
						...
						<li
							...
							<a class="page-link"
							href="viewlistproductbycate.do?op=GotoPage&gotoPage=${listNumberBox.get(1)}">
						...
						<li
							...
							<a class="page-link"
							href="viewlistproductbycate.do?op=GotoPage&gotoPage=${listNumberBox.get(2)}">
						...
						<li
							...
							href="viewlistproductbycate.do?op=NextPage" aria-label="Next"> <span
						...
						<li
							class="page-item ${homePage==totalHomePage?'disabled':''}">
							<!-- disabled --> <a class="page-link "
							href="viewlistproductbycate.do?op=LastPage" aria-label="Next"> <span
