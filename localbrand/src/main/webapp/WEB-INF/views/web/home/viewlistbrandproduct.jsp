		...
		<div class="col-lg-9 col-md-12">
			<div class="text-center mb-4">
				<h2 class="section-title px-5">
					<span class="px-2">${brandname}</span>
				</h2>
			</div>
				...
				<nav aria-label="Page navigation">
					<ul class="pagination justify-content-center mb-3">
						<li class="page-item ${homePage==1?'disabled':''}"><a
							class="page-link  " href="viewlistbrandproduct.do?op=FirstPage"
							aria-label="Previous"> <span aria-hidden="true">&laquo;</span>
						</a></li>
						<li class="page-item  ${homePage==1?'disabled':''}"><a
							class="page-link" href="viewlistbrandproduct.do?op=PreviousPage"
							aria-label="Next"> <span aria-hidden="true"><</span>
						</a></li>
						<li
							class="page-item  ${homePage==listNumberBox.get(0)?'active':''}">
							<a class="page-link"
							href="viewlistbrandproduct.do?op=GotoPage&gotoPage=${listNumberBox.get(0)}">
						...
						<li
							...
							<a class="page-link"
							href="viewlistbrandproduct.do?op=GotoPage&gotoPage=${listNumberBox.get(1)}">
						...
						<li
							...
							<a class="page-link"
							href="viewlistbrandproduct.do?op=GotoPage&gotoPage=${listNumberBox.get(2)}">
						...
						<li
							...
							href="viewlistbrandproduct.do?op=NextPage" aria-label="Next"> <span
						...
						<li
							class="page-item ${homePage==totalHomePage?'disabled':''}">
							<!-- disabled --> <a class="page-link "
							href="viewlistbrandproduct.do?op=LastPage" aria-label="Next"> <span
