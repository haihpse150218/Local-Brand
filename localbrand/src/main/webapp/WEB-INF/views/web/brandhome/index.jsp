								...
								<div class="col-md-6 pb-4">
									<div
										...
										<div class="position-relative" style="z-index: 1;">
											...
											<a
												href="/localbrand/web/brandhome/collection/index.do?collectionId=${collection.getId()}"
												class="btn btn-outline-primary py-md-2 px-md-3">Explore</a>
										</div>
									</div>
								</div>
							</c:forEach>
...
<div class="text-center ">
	<h2 class="section-title px-5">
		<span class="px-2">Brand Products</span>
	</h2>
</div>
			...
			<div class="border-bottom mb-4 pb-4 mt-5">
				...
				<form action="/localbrand/web/brandhome/search.do">
					<input type="hidden" name="txtSearchQuery"
						value="${requestScope.txtSearchQuery}"> <input
						type="hidden" name="txtSortBy" value="${requestScope.txtSortBy}">
					<input type="hidden" name="txtCateId"
						value="${requestScope.txtCateId}">
					<div class="multi-range-field form-group">


						<span id="rangeval1">${(requestScope.txtPriceRange1 == null)? (0) : (requestScope.txtPriceRange1)}<!-- Default value --></span><br>
						<input type="range" id="range1"
							class="form-range w-75 text-primary" name="txtPriceRange1"
						...
						<form action="/localbrand/web/brandhome/search.do">
							<div class="input-group">
								<input type="text" name="txtSearchQuery" class="form-control"
									...
									placeholder="Search by name"> <input type="hidden"
									name="txtSortBy" value="${requestScope.txtSortBy}"> <input
									type="hidden" name="txtCateId"
									value="${requestScope.txtCateId}">
							...
							<nav
								...
								<div id="cate-list" class="navbar-nav w-100 overflow-hidden">
									<c:forEach var="category"
										items="${requestScope.brand.getBrandCategoryList()}">
										<form action="/localbrand/web/brandhome/search.do">
