...
<body>
            ...
            <div class="col-lg-8">
                <div class="mb-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            <label>City</label>
                            <select class="custom-select" onchange="print_distric(this.selectedIndex);" id="state">

                            </select>
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Distric</label>
                            <select class="custom-select" id="distric">
    ...
    <script>
        var s_a = new Array();
        var state_arr = new Array("Hồ Chí Minh", "Hà Nội", "Hải Phòng", "Cần Thơ", "Đồng Nai", "Bắc Ninh", "Hải Dương", "Nghệ An", "Thừa Thiên-Huế", "Thanh Hóa", "Khánh Hòa", "Nam Định", "Đắk Lắk", "Thái Nguyên", "Bà Rịa-Vũng Tàu", "Cà Mau", "Bình Định", "Sóc Trăng", "An Giang", "Phú Thọ", "Thái Bình", "Quảng Ngãi", "Kiến Giang", "Bình Dương", "Phú Yên", "Bạc Liêu", "Bình Thuận", "Ninh Thuận", "Quảng Ninh", "Hà Tĩnh", "Quảng Bình", "Đồng Tháp", "Lạng Sơn", "Gia Lai", "Long An", "Trà Vinh", "Ninh Bình", "Tây Ninh", "Tiền Giang", "Hòa Bình", "Vĩnh Long", "Hậu Giang", "Yên Bái", "Lào Cai", "Bến Tre", "Bắc Giang", "Cao Bằng", "Hà Giang", "Tuyên Quang", "Bắc Kạn", "Sơn La", "Quảng Trị", "Đà Nẵng", "Hưng Yên", "Hà Nam", "Vĩnh Phúc", "Quảng Nam", "Điện Biên", "Bình Phước", "Lâm Đồng", "Lai Châu", "Kon Tum", "Đắk Nông");
        ...
        function print_distric(city_index) {
            ...
            option_str.length = 0;
            option_str.options[0] = new Option('Select Distric', '');
            option_str.selectedIndex = 0;
            var distric_arr = s_a[city_index - 1].split("|");

            for (var i = 0; i < distric_arr.length; i++) {

                option_str.options[option_str.length] = new Option(distric_arr[i], distric_arr[i]);
            }
        }
    </script>
