    ...
    <div class="container-fluid py-5">
        <div class="row px-xl-5">
                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner border">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" src="<%=p.getPath()%>" alt="Image">
                        </div>
                    </div>
            ...
            <div class="col-lg-7 pb-5">
                <h3 class="font-weight-semi-bold"><%=p.getName()%></h3>
                ...
                <h3 class="font-weight-semi-bold mb-4">$<%=p.getPrice()%></h3>
                <p class="mb-4"><%=p.getDes()%></p>
                
                <form action="mainController" method="post">
                <input type="hidden" name="pid" value="<%=p.getId()%>">
                <div class="d-flex align-items-center mb-4 pt-2">
                    <div class="input-group quantity mr-3" style="width: 130px;">
                        <input type="number"  name="txtnum" class="form-control bg-secondary text-center" value="1" min="1">
                    </div>
                    <button name="action" value="addToCart" class="btn btn-primary px-3"><i class="fa fa-shopping-cart mr-1"></i> Add To Cart</button> 
                </div>
                </form>
                ...
                <div class="owl-carousel related-carousel">
                    <%
                        if(request.getAttribute("pList")!=null){
                            ArrayList<Plant> pList = (ArrayList<Plant>)request.getAttribute("pList");
                            for (Plant p : pList) {
                    %>
